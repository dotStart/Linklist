...
/**
 * Shows the deleted links in the recycle bin in the linklist moderation.
 *
 * @author 	Christoph H.
 ...
 */
class LinkListModerationDeletedLinksPage extends MultipleLinkPage {
	// system
	...
	public function readParameters() {
		...
		$this->linkList->sqlConditions .= 'isDeleted = 1';
	}
	...
	public function assignVariables() {
		...
		WCF::getTPL()->assign(array(
			...
			'url' => 'index.php?page=LinkListModerationDeletedLinks'.'&pageNo='.$this->pageNo.SID_ARG_2ND_NOT_ENCODED,
			'action' => 'deletedLinks'
		));
	}
