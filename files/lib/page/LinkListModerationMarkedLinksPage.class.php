...
/**
 * Shows the marked links in the linklist moderation.
 *
 * @author 	Christoph H.
 ...
 */
class LinkListModerationMarkedLinksPage extends MultipleLinkPage {
	// system
	...
	public function readParameters() {
		...
		$this->linkList->sqlConditions .= 'linkID IN ('.(WCF::getSession()->getVar('markedLinkListLinks') ? implode(',', WCF::getSession()->getVar('markedLinkListLinks')) : 0).')';
	}
	...
	public function assignVariables() {
		...
		WCF::getTPL()->assign(array(
			...
			'url' => 'index.php?page=LinkListModerationMarkedLinks'.'&pageNo='.$this->pageNo.SID_ARG_2ND_NOT_ENCODED,
			'action' => 'markedLinks'
		));
	}
	...
	public function show() {
		...
		// check permission
		WCF::getUser()->checkPermission('mod.linkList.canEditLink');
